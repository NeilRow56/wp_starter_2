...
export default function HeroPage() {
  return (
    <div className='w-full bg-[#f7f6fb] pt-[3vh] lg:h-screen dark:bg-zinc-950'>
        ...
        <div className='grid grid-cols-1 items-center gap-12 lg:grid-cols-2'>
          ...
          <div>
            ...
            <div className='mt-2 rounded-2xl bg-blue-500 p-6'>
              <h1 className='mt-6 mb-6 text-2xl font-bold text-white sm:text-4xl md:text-5xl md:leading-[3rem] lg:leading-[3.5rem]'>
            ...
            <ul className='text-muted-foreground mt-8 mb-[80px] max-w-xl list-disc space-y-4 pl-4 font-bold'>
